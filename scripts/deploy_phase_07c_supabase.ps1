...
try {
    ...
    Write-Host ""
    Write-Host "==> Applying Phase 07C Supabase migration" `
    ...
    Write-Host "[ OK ] Phase 07C migration was pushed." `
        -ForegroundColor Green
}
catch {
