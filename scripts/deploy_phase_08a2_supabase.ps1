...
try {
    ...
    Write-Host ""
    Write-Host "==> Applying Phase 08A-2 Supabase migration" `
    ...
    Write-Host "[ OK ] Phase 08A-2 storage ownership migration was pushed." `
